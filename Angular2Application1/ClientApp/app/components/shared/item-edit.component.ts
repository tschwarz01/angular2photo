...
const INLINE_EDIT_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: forwardRef(() => ItemEditComponent),
    multi: true
};

@Component({
    selector: 'item-edit',
    template: require('./item-edit.component.html'),
    providers: [INLINE_EDIT_CONTROL_VALUE_ACCESSOR],
    styles: [require('./item-edit.component.css')]
})

export class ItemEditComponent implements ControlValueAccessor, OnInit {
